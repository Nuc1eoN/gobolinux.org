...
--118
{
  ...
  date  = [[2025/03/XX]],
  body  = [===[
<p>We are pleased to announce the release of <b>GoboLinux 017.01</b>, an eagerly
awaited bug-fix update that addresses several critical issues since the 017 ISO release!</p>
<p>Along with this release, Hisham Murhammad, founder and steward of GoboLinux for the past
...
<p>We extend our gratitude towards our contributors, who shaped this release: Sage I. Hendricks (<a
            href="https://github.com/sage-etcher">@sage-etcher</a>), <a href="https://github.com/xplshn">
